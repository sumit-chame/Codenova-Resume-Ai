  ...
  return (
    <div className="glass-panel border border-slate-800 rounded-3xl p-8 shadow-2xl space-y-6">
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-extrabold text-slate-100 tracking-tight">Create Free Account</h2>
        <p className="text-xs text-slate-400">Start building your ATS-friendly resume in minutes</p>
      </div>
      ...
      <Button
        ...
        onClick={async () => {
          await signup('alex.morgan@example.com', 'password123', 'Alex Morgan');
          toastSuccess('Demo Account Activated!', 'Welcome to ResumeForge AI.');
          navigate('/dashboard');
        }}
